  ...
  internal sealed class MyGuid
    {
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="MyGuid"/>.
        /// </summary>
        /// <remarks>
        /// This constructor is intended to be used from unit tests and
        /// benchmarks only. For production use use <see cref="MyGuid()"/> instead.
        /// </remarks>
        ...
        internal MyGuid(RandomNumberGenerator rng = null, ulong? sequential = null, uint? increment = null)
        {
            if (rng is null)
